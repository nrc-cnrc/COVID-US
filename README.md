...
:-------------------------:|:-------------------------:|:-------------------------:|:-------------------------:|:-------------------------:|:-------------------------:
<img src="figure/6_butterfly_covid.gif"  alt="US video of a COVID-19 patient" width="60" height="103">  |  <img src="figure/6_butterfly_covid_cropped.gif" alt="cropped video" width="40%" height="20%">  |  <img src="figure/6_butterfly_covid_cropped_convex_frame0.jpg" alt="first frame extracted from the video" width="40%" height="20%">  |  <img src="figure/6_butterfly_covid_prc_convex_main_mask.jpg" alt="first frame mask" width="40%" height="20%">  |  <img src="figure/6_butterfly_covid_cropped_convex_frame67.jpg" alt="frame with moving pointer extracted from the video" width="40%" height="20%">  |  <img src="figure/6_butterfly_covid_prc_convex_frame67_mask.jpg" alt="frame with moving pointer mask" width="40%" height="20%">
